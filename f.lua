...
if queueonteleport then
    queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/ThatoneOrange/test/main/f.lua'))()")
end
...
if C4 then
    ...
    while true do
        ...
        warn('next')
        Grabbed += 1
        if CashInBag.Value >= LootToGrab or Grabbed >= LootToGrab then
            break
        end
    end
    print('done')
