...
if queueonteleport then
    queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/ThatoneOrange/test/main/u.lua'))()")
end
...
if C4 then
    ...
    while true do
        ...
        if CashInBag.Value >= LootToGrab then
            break
        end
        ...
        repeat
            wait()
            fireproximityprompt(pile.ProximityPrompt, 1)
        until CashInBag.Value - oldLootInBag <= 1
        print('Ended1')
    end
    print('done')
    task.wait()
