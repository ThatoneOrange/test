...
if queueonteleport then
    queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/ThatoneOrange/test/main/ballz.lua'))()")
end
...
local Camera = workspace:WaitForChild('Camera') -- workspace.CurrentCamera (if bugs replace)
